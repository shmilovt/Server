...
public class Converter {
    ...
    public SearchResultsDTO convertToDTO(SearchResults searchResult) {
        ...
        for (ResultRecord resultRecord : resultRecordList) {
            ...
            tempResultRecordDTO.setBalcony(resultRecord.getBalcony()==1);
            tempResultRecordDTO.setYard(resultRecord.getYard()==1);
            tempResultRecordDTO.setAnimals(resultRecord.getAnimals()==1);
            tempResultRecordDTO.setWarehouse(resultRecord.getWarehouse()==1);
            tempResultRecordDTO.setProtectedSpace(resultRecord.getProtectedSpace()==1);
    ...
    public List<ApartmentDTO> convertToDTOAdminApartment(SearchResults searchResult) {
        ...
        for (ResultRecord resultRecord : resultRecordList) {
            ...
            apartmentDTO.setBalcony(resultRecord.getBalcony());
            apartmentDTO.setYard(resultRecord.getYard());
            apartmentDTO.setAnimals(resultRecord.getAnimals());
            apartmentDTO.setWarehouse(resultRecord.getWarehouse());
            apartmentDTO.setProtectedSpace(resultRecord.getProtectedSpace());
