...
//        String sql = "SELECT * FROM AddressDetails where addressDetailsNum=" + "'" + addressDetailsID + "'";
    ...
    public static void main(String[] args) throws Exception {
       ...
       //servercontroller
        ...
        servercontroller.newPost(new Post("1231C_223411", new Date(new Date().getTime()-1111111111), "srolik prolik","\"דירה מרוהטת ✔️ משופצת ✔️ ליד האוניברסיטה✔️\\n‼️מראה את הדירה היום בתיאום מראש‼️\\n\uD83D\uDCF1לפרטים: תומר 054-5918161\\nמתאימה ל-3 שותפים. \uD83D\uDCA5החל מ-850 ש\\\"ח לחדר!\uD83D\uDCA5\\n✔️דירה משופצת מן היסוד בקומה שנייה, מאווררת ומרווחת (70 מ\\\"ר) :\\n✔️מרוהטת: בכל חדר מיטה, מזגן, ארון, שולחן כתיבה וכיסא\\n✔️מקרר, כיריים, מכונת כביסה ועוד\\n✔️11 דק' הליכה מהאוניברסיטה\\n✔️1 דקה הליכה מ\\\"בר גיורא\\\" ו5 דק מהפאבים/מסעדות במצדה.\\n✔️ רק 850-950 ש\\\"ח לחדר\\nבבר גיורא פינת רבי-עקיבא\\n\"", ""));
